public class AVLTree<T extends Comparable<T>> extends BST<T> {
   ...
   protected void rotateRight() {
       ...
       T val = root.data; //Storing the value of the root to adjust its position
       root.data = root.right.data;
       root.right.data = val;

       getRightAVL().adjustHeight(); //adjusting the height of the right subtree, then the whole tree
       adjustHeight();
   }
